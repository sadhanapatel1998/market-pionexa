<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvas-sidebar">
    <div class="offcanvas-header">
        <div class="offcanvas-logo">
            <figure>
                <img src="assets/images/logo/logo.png" alt="offcanvas logo">
            </figure>
        </div>
    ...
    <div class="offcanvas-body">
        ...
        <div class="offcanvas-about d-none d-xl-block">
            <p>
                Market Pionexa Consulting helps healthcare, technology, and growth-focused
                organizations transform strategy into measurable outcomes through operational
                excellence and execution-focused business solutions.
            </p>
        </div>
            ...
            <div class="row align-items-center justify-content-between g-0">
                <div class="col-12">
                    <div class="header-content d-flex align-items-center">
                        ...
                        <div class="header-navigation d-flex align-items-center m-auto">
                            <div class="main-menu">
                                <nav id="mobile-menu">
                                    <ul>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <!-- <ul class="submenu">
                                                ...
                                                <li><a href="technology.php">Technology & SaaS</a></li>
                                                <li><a href="growth-expansion.php">Growth & Market Expansion</a></li>
                                            </ul> -->
                                        </li>
                        ...
                        <div class="header-right d-flex align-items-center gap-3">
                            ...
                            <div class="button-wapper">
                                ...
                                <div class="header-sidebar">
                                    <a class="sidebar-toggler" data-bs-toggle="offcanvas" href="#offcanvas-sidebar"
                                        aria-label="sidebar toggler" role="button" aria-controls="offcanvas-sidebar">
                                        <span></span>
                                        <span></span>
                                    </a>
                                </div>
        ...
        <div class="search-wapper">
            <form action="#" class="search-form" id="search-form">
                <div class="input-group">
                    <input type="text" id="searchs" name="search" placeholder="Type to search" autocomplete="off"
                        required="required">
                </div>
                <button type="submit" class="search-submit-btn" data-text="search submit">
                    <i class="fa-solid fa-magnifying-glass"></i>
                </button>
            </form>
        </div>
