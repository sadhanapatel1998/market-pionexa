                            ...
                            <div class="col-xl-3 col-lg-12">
                                ...
                                <div class="footer-widget footer-widget-about wow fadeInUp" data-wow-delay=".2s">
                                    ...
                                    <div class="info">
                                        ...
                                        <a class="call" href="tel:+123446788">+1 234 467 88</a>
                                    </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="footer-widget footer-widget-quick-links wow fadeInUp"
                                                    ...
                                                    <div class="widget-link">
                                                        <ul class="link">
                                                            ...
                                                            <li>
                                                                <a href="blog.html"><i
                                                                        class="fa-solid fa-chevron-right"></i> Blog</a>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                ...
                                                <div class="footer-widget footer-widget-services wow fadeInUp"
                                                    data-wow-delay=".4s">
                                                    <h3 class="footer-widget-title line-anime">Company</h3>
                                                    <!-- widget link start -->
                                                    <div class="widget-link">
                                                        <ul class="link">
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="sign-up.html"><i
                                                                        class="fa-solid fa-chevron-right"></i> Sign
                                                                    Up</a>
                                                            </li>
                                                            <li>
                                                                <a href="login.html"><i
                                                    ...
                                                    <div class="widget-contact">
                                                        ...
                                                        <form action="#" class="subscribe-form" id="subscribe-form">
                                                            ...
                                                            <button type="submit" class="submit-btn"
                                                                data-text="subscribe" aria-label="subscribe"> <i
                        ...
                        <div class="row align-items-center"> 
                            <div class="col-lg-6">
                                ...
                                <div class="copyright-text wow fadeInUp" data-wow-delay=".2s">
                                    <p class="m-0">&#169; Copyright 2026 pexora All Rights Reserved</p>
                                </div>
