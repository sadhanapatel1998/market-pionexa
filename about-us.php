    ...
    <section class="about-section-2 pt-100 md-pt-80 pb-100 md-pb-80">
        <div class="container">
            <div class="row">
                        ...
                        <!-- <div class="about-features-wappper">
                            ...
                            <div class="about-features-item">
                                <div class="about-features-icon">
                                    <figure>
                                        <img src="assets/images/about/icon-2-1.png" alt="Operational Excellence">
                                    </figure>
                                </div>
                                <div class="about-features-title">
                                    <h3>Operational Excellence</h3>
                                    <p>
                                        Streamlining business operations through practical strategies, process
                                        optimization, and execution-focused solutions that improve efficiency and
                                        performance.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="about-features-item">
                                <div class="about-features-icon">
                                    <figure>
                                        <img src="assets/images/about/icon-2-2.png" alt="Business Growth & Expansion">
                                    </figure>
                                </div>
                                <div class="about-features-title">
                                    <h3>Business Growth & Expansion</h3>
                                    <p>
                                        Supporting organizations with customer success, market expansion, operational
                                        support, and scalable business execution for long-term growth.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="about-right wow fadeInUp" data-wow-delay=".3s">
